...
export const leaveRequestServices = {
  ...
  create: async (data: CreateLeaveRequest, token: string): Promise<ApiResponse<{ leave_request: import('@/types/leave-requests').LeaveRequest }> | ApiErrorResponse> => {
  ...
  list: async (params: ListLeaveRequestsParams = {}, token: string): Promise<ApiResponse<{ leave_requests: import('@/types/leave-requests').LeaveRequest[] }> | ApiErrorResponse> => {
  ...
  getById: async (id: string, token: string): Promise<ApiResponse<{ leave_request: import('@/types/leave-requests').LeaveRequest }> | ApiErrorResponse> => {
  ...
  getByStudent: async (studentId: string, params: Omit<ListLeaveRequestsParams, 'student_id'> = {}, token: string): Promise<ApiResponse<{ leave_requests: import('@/types/leave-requests').LeaveRequest[] }> | ApiErrorResponse> => {
    return leaveRequestServices.list({ ...params, student_id: studentId }, token);
  },

  // Get leave requests for a specific class division
  getByClass: async (classDivisionId: string, params: Omit<ListLeaveRequestsParams, 'class_division_id'> = {}, token: string): Promise<ApiResponse<{ leave_requests: import('@/types/leave-requests').LeaveRequest[] }> | ApiErrorResponse> => {
